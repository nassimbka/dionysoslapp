...
# /////////////////// Venues ////////////////
zygobar = Venue.create(name: "Le Zygobar", kind: "bar", address: "35 rue des Olivettes, 44000 Nantes", url: "https://www.facebook.com/zygo.bar/") # bar à concert, jazz, culture, ambiance, theme
...
aux_ptits_joueurs = Venue.create(name: "Aux Ptits Joueurs", kind: "bar", address: "23 Rue du Port Guichard 44000 Nantes", url: "https://www.facebook.com/ptitsjoueurs/") # activité, groupe, posé, typique/traditionnel, boule nantaise, boire, manger un bout, concert, jeux
...
# ////////////// Conversion words ///////////
conversion_word_1 = ConversionWord.create(name: "", tag: )
# //////////////////// Tags /////////////////
